...
class MyApp extends StatelessWidget {
  final pages =[
    PageViewModel(
      ...
      title: Text("Recycle"),
      body: Text("Recycling is the process to converting waste materials into new materials and objects"),
    ...
    PageViewModel(
      ...
      title: Text("Reduce"),
      body: Text("Reducing is about to understanding how to not produce trash."),
    ...
    PageViewModel(
      ...
      title: Text("Reuse"),
      body: Text("Reuse is the action or practice of using an item, whether for its original purpose or to fulfill a different function."),
